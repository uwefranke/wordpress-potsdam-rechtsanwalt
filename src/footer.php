<footer class="site-footer" role="contentinfo">
    ...
    <div class="footer-bottom">
        ...
        <a href="<?php echo esc_url(home_url('/impressum')); ?>" style="color: rgba(255, 255, 255, 0.8); text-decoration: underline;">Impressum</a> | 
        <a href="<?php echo esc_url(home_url('/datenschutz')); ?>" style="color: rgba(255, 255, 255, 0.8); text-decoration: underline;">Datenschutz</a> | 
        <?php echo do_shortcode('[cookie_einstellungen text="Cookie-Einstellungen" style="color: rgba(255, 255, 255, 0.8); text-decoration: underline; cursor: pointer;"]'); ?></p>
    </div>
</footer>
