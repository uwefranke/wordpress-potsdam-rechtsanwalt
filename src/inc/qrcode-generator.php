 ...
 * 1. WordPress-Plugin "QR Code Generator" (empfohlen, lokal, DSGVO-konform)
 * 2. WordPress-Plugin "WP QR Code Generator"
 * 3. Fallback: Google Chart API (extern, nur wenn nötig)
 * 
 * EMPFEHLUNG: Installiere "QR Code Generator" Plugin für lokale Generierung
...
if (!function_exists('potsdam_qrcode_notice')) {
    ...
    function potsdam_qrcode_notice() {
        ...
        if (shortcode_exists('qrcode') || function_exists('wpqr_generate_code')) {
        ...
        <div class="notice notice-info is-dismissible">
            <p><strong>Potsdam Rechtsanwalt Theme:</strong> Für optimale DSGVO-Konformität empfehlen wir die Installation des <a href="<?php echo admin_url('plugin-install.php?s=qr+code+generator&tab=search&type=term'); ?>" target="_blank">"QR Code Generator"</a> Plugins für lokale QR-Code-Generierung.</p>
